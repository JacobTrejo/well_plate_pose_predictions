...
resnetWeights = 'weights/resnet_pose_best_python_230608_four_blocks.pt'
...
while success:
    ...
    cc_list = superImpose(image)
    
    full_cc_list = full_cc_list + cc_list
...
np.save(outputsFolder + 'cc/'  + videoName +  '.npy', full_cc_list)
vidcap.release()
#output.release()
